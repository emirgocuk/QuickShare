"""
QuickShare Build Script - CustomTkinter Version
PyInstaller ile modern GUI exe oluşturma
"""
    ...
    try:
        ...
        if os.path.exists(exe_path):
            ...
            if size_mb > 5:
                ...
                print("   CustomTkinter ek dependency getirdi")
